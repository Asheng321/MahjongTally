...
import android.content.DialogInterface;
 ...
 public class Mahjong3KJDialog extends AlertDialog {
  public Mahjong3KJDialog(Context context) {
    super(context);
    View v = getLayoutInflater().inflate(R.layout.tkj_input_dialog, null);
